package com.conversation.config;

import com.conversation.config.liquibase.AsyncSpringLiquibase;
...
@Configuration
@EnableJpaRepositories("com.conversation.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("com.conversation.repository.search")
